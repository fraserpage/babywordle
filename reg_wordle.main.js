            ...
            value: function () {
              ...
              this.shadowRoot.appendChild(Sa.content.cloneNode(!0)),
                ...
                (this.shadowRoot.querySelector("#puzzle-number").textContent =
                  "#".concat(this.gameApp.dayOffset + 1)),
                this.shadowRoot.addEventListener(
                  "game-switch-change",
                  function (e) {
                    e.stopPropagation();
