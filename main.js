...
(this.wordle = this.wordle || {}),
          ...
          o(t, [
            {
              key: "evaluateRow",
              value: function () {
                if (WORD_LEN === this.tileIndex && !(this.rowIndex >= 6)) {
                  var e,
            ...
            },
            {
              ...
              value: function () {
                var e = this.shadowRoot.querySelector("#board-container"),
                  a = Math.min(
                    Math.floor(e.clientHeight * (WORD_LEN / 6)),
                    350
                  ),
                  s = 6 * Math.floor(a / WORD_LEN);
              ...
              value: function () {
                ...
                for (var a = 0; a < 6; a++) {
                  ...
                  s.setAttribute("letters", this.boardState[a]),
                    s.setAttribute("length", WORD_LEN),
                      ...
                      (a.path || (a.composedPath && a.composedPath())).includes(
                        ...
                        ([es, as].includes(e.gameStatus) &&
                          (e.restoringFromLocalStorage
                            ? (e.showStatsModal(),
                                e.$game.querySelector("#statistics-button")
  ...
  ***************************************************************************** */
    ...
    let exWord = [];
    for (let l = 0; l < 3; l++){
      exWord[l] = POSSIBLE_NAMES[Math.round(Math.random() * POSSIBLE_NAMES.length)];
      example[l] = '';
      for (let i = 0; i < WORD_LEN; i++){
        if (l === 0 && i == 0){
          example[l] += '<game-tile letter="'+exWord[l][i]+'" evaluation="correct" reveal></game-tile>\n  '
        }
        else if (l === 1 && i == 1){
          example[l] +=  '<game-tile letter="'+exWord[l][i]+'" evaluation="present" reveal></game-tile>\n  '
        } 
        else if (l === 2 && i == 2){
          example[l] +=  '<game-tile letter="'+exWord[l][i]+'" evaluation="absent" reveal></game-tile>\n  '
        }
        else{
          example[l] += '<game-tile letter="'+exWord[l][i]+'"></game-tile>\n  '
        }
      }
    }
    $s.innerHTML =
      '\n  <style>\n  .instructions {\n    font-size: 14px;\n    color: var(--color-tone-1)\n  }\n\n  .examples {\n    border-bottom: 1px solid var(--color-tone-4);\n    border-top: 1px solid var(--color-tone-4);\n  }\n\n  .example {\n    margin-top: 24px;\n    margin-bottom: 24px;\n  }\n\n  game-tile {\n    width: 40px;\n    height: 40px;\n  }\n\n  :host([page]) section {\n    padding: 16px;\n    padding-top: 0px;\n  }\n\n  </style>\n  <section>\n    <div class="instructions">\n      <p style="padding-right:2em">Guess the <strong>BABY WORDLE</strong> (the name of Hilary and Ben\'s son) in 6 tries.</p>\n      <p  style="padding-right:2em">Each guess must be a valid '+WORD_LEN+' letter boy\'s name. Hit the enter button to submit.</p>\n      <p  style="padding-right:2em">After each guess, the color of the tiles will change to show how close your guess was to the word.</p>\n      <div class="examples">\n        <p><strong>Examples</strong></p>\n        <div class="example">\n          <div class="row">\n            '+example[0]+'</div>\n          <p>The letter <strong>'+exWord[0][0].toUpperCase()+'</strong> is in the word and in the correct spot.</p>\n        </div>\n        <div class="example">\n          <div class="row">\n            '+example[1]+'       </div>\n          <p>The letter <strong>'+exWord[1][1].toUpperCase()+'</strong> is in the word but in the wrong spot.</p>\n        </div>\n        <div class="example">\n          <div class="row">\n            '+example[2]+'         </div>\n          <p>The letter <strong>'+exWord[2][2].toUpperCase()+'</strong> is not in the word in any spot.</p>\n        </div>\n      </div>\n      <p><strong>A new BABY WORDLE will be available each birth!<strong></p>\n    </div>\n  </section>\n';
    var Hs = (function (e) {
      r(t, e);
      var a = h(t);
      function t() {
